...
namespace FFBPluginGUI {
	...
	/// <summary>
	/// Summary for AfterburnerClimax
	/// </summary>
	public ref class AfterburnerClimax : MetroFramework::Forms::MetroForm
	{
	public:	
		AfterburnerClimax(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &AfterburnerClimax::Form1_FormClosing);
			// 
			// metroTextBox1
			// 
			// 
			...
			this->metroToolTip1->SetToolTip(this->metroTextBox5, L"Strength of rumble effect 1");
			this->metroToolTip1->SetToolTip(this->metroTextBox6, L"Strength of rumble effect 2");
			this->metroToolTip1->SetToolTip(this->metroTextBox7, L"Length of rumble effect 1 feedback");
			this->metroToolTip1->SetToolTip(this->metroTextBox8, L"Length of rumble effect 2 feedback");
			// 
			// metroStyleManager1
			// 
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLink1_Click);
			// 
			// metroComboBox1
			// 
			...
			if (SDL_NumJoysticks() == 0)
			{
				...
				this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroComboBox1_SelectedIndexChanged);
			...
			this->numericUpDown3->Location = System::Drawing::Point(20, 229);
			...
			this->numericUpDown3->ValueChanged += gcnew System::EventHandler(this, &AfterburnerClimax::numericUpDown3_ValueChanged_1);
			// 
			// metroCheckBox1
			// 
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &AfterburnerClimax::metroCheckBox6_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
			...
			this->metroTextBox5->Lines = gcnew cli::array< System::String^  >(1) { L"Rumble 1 Strength" };
			this->metroTextBox5->Location = System::Drawing::Point(20, 362);
			...
			this->metroTextBox5->Text = L"Rumble 1 Strength";
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
			int Rumble1Strength = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble1Strength"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroTrackBar2->BackColor = System::Drawing::Color::Transparent;
			this->metroTrackBar2->Location = System::Drawing::Point(20, 388);
			...
			this->metroTrackBar2->Value = Rumble1Strength;
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar2_Scroll);
			// 
			// metroTrackBar3
			// 
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar3_Scroll);
			// 
			// metroTextBox6
			// 
			// 
			...
			this->metroTextBox6->Lines = gcnew cli::array< System::String^  >(1) { L"Rumble 2 Strength" };
			this->metroTextBox6->Location = System::Drawing::Point(163, 362);
			...
			this->metroTextBox6->Text = L"Rumble 2 Strength";
			...
			// metroTrackBar4
			// 
			int Rumble2Strength = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble2Strength"), 0, TEXT(".\\FFBPlugin.ini"));
			...
			this->metroTrackBar4->Value = Rumble2Strength;
			this->metroTrackBar4->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar4_Scroll);
			// 
			// metroTextBox7
			// 
			// 
			...
			this->metroTextBox7->Lines = gcnew cli::array< System::String^  >(1) { L"Rumble 1 Length" };
			this->metroTextBox7->Location = System::Drawing::Point(17, 443);
			...
			this->metroTextBox7->Text = L"Rumble 1 Length";
			...
			this->metroTextBox8->Lines = gcnew cli::array< System::String^  >(1) { L"Rumble 2 Length" };
			this->metroTextBox8->Location = System::Drawing::Point(163, 443);
			...
			this->metroTextBox8->Text = L"Rumble 2 Length";
			...
			// metroTrackBar5
			// 
			int Rumble1Length = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble1Length"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroTrackBar5->BackColor = System::Drawing::Color::Transparent;
			this->metroTrackBar5->Location = System::Drawing::Point(17, 472);
			...
			this->metroTrackBar5->Value = Rumble1Length;
			this->metroTrackBar5->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar5_Scroll);
			// 
			// metroTrackBar6
			// 
			int Rumble2Length = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble2Length"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroTrackBar6->BackColor = System::Drawing::Color::Transparent;
			this->metroTrackBar6->Location = System::Drawing::Point(163, 472);
			...
			this->metroTrackBar6->Value = Rumble2Length;
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &AfterburnerClimax::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel1_Click);
			// 
			// metroLabel2
			// 
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel2_Click);
			// 
			// metroLabel3
			// 
			int Rumble1Strength1 = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble1Strength"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroLabel3->AutoSize = true;
			this->metroLabel3->Location = System::Drawing::Point(67, 414);
			this->metroLabel3->Name = L"metroLabel3";
			this->metroLabel3->Size = System::Drawing::Size(0, 0);
			this->metroLabel3->TabIndex = 26;
			this->metroLabel3->TabStop = false;
			this->metroLabel3->Text = System::Convert::ToString(Rumble1Strength1);
			this->metroLabel3->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel3_Click);
			// 
			// metroLabel4
			// 
			int Rumble2Strength1 = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble2Strength"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroLabel4->AutoSize = true;
			this->metroLabel4->Location = System::Drawing::Point(213, 414);
			...
			this->metroLabel4->Text = System::Convert::ToString(Rumble2Strength1);
			this->metroLabel4->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel4_Click);
			// 
			// metroLabel5
			// 
			int Rumble1Length1 = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble1Length"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroLabel5->AutoSize = true;
			this->metroLabel5->Location = System::Drawing::Point(67, 498);
			...
			this->metroLabel5->Text = System::Convert::ToString(Rumble1Length1);
			this->metroLabel5->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel5_Click);
			// 
			// metroLabel6
			// 
			int Rumble2Length1 = GetPrivateProfileInt(TEXT("Settings"), TEXT("Rumble2Length"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroLabel6->AutoSize = true;
			this->metroLabel6->Location = System::Drawing::Point(213, 498);
			...
			this->metroLabel6->Text = System::Convert::ToString(Rumble2Length1);
			this->metroLabel6->Click += gcnew System::EventHandler(this, &AfterburnerClimax::metroLabel6_Click);
			// 
			// AfterburnerClimax
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(300, 542);
...
#pragma endregion
	...
	private: System::Void metroLabel3_Click(System::Object^  sender, System::EventArgs^  e) //Rumble1Strength Number Change
	{

	}
	private: System::Void metroLabel4_Click(System::Object^  sender, System::EventArgs^  e) //Rumble2Strength Number Change
	{

	}
	private: System::Void metroLabel5_Click(System::Object^  sender, System::EventArgs^  e) //Rumble1Length Number Change
	{

	}
	private: System::Void metroLabel6_Click(System::Object^  sender, System::EventArgs^  e) //Rumble2Length Number Change
	{

	}
	private: System::Void metroTrackBar2_Scroll(System::Object^  sender, System::Windows::Forms::ScrollEventArgs^  e) //Rumble1 Strength
	{
		metroLabel3->Text = metroTrackBar2->Value.ToString();
		Decimal value = metroTrackBar2->Value;
		int myInt{ value };
		char Result[16];
		sprintf_s(Result, "%d", myInt);
		{
			WritePrivateProfileStringA("Settings", "Rumble1Strength", Result, ".\\FFBPlugin.ini");
		}
	}
	private: System::Void metroTrackBar4_Scroll(System::Object^  sender, System::Windows::Forms::ScrollEventArgs^  e) //Rumble2 Strength
	{
		...
		sprintf_s(Result, "%d", myInt);
		{
			WritePrivateProfileStringA("Settings", "Rumble2Strength", Result, ".\\FFBPlugin.ini");
		}
	}
	private: System::Void metroTrackBar5_Scroll(System::Object^  sender, System::Windows::Forms::ScrollEventArgs^  e) //Rumble1 Length
	{
		...
		sprintf_s(Result, "%d", myInt);
		{
			WritePrivateProfileStringA("Settings", "Rumble1Length", Result, ".\\FFBPlugin.ini");
		}
	}
	private: System::Void metroTrackBar6_Scroll(System::Object^  sender, System::Windows::Forms::ScrollEventArgs^  e) //Rumble2 Length
	{
		...
		sprintf_s(Result, "%d", myInt);
		{
			WritePrivateProfileStringA("Settings", "Rumble2Length", Result, ".\\FFBPlugin.ini");
		}
	}
