...
namespace FFBPluginGUI {
	...
	public ref class AliensExtermination : Helper
	{
	public:
		AliensExtermination(MetroForm^ obj1)
		{
			this->obj = obj1;
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddShortCheckBox("EscapeKeyExitViaPlugin", L"Escape Key to Exit", L"Enable to make plugin exit game if you press escape");
			...
			this->AutoAddLongComboBoxBlock(
				"HowtoRumbleFlameEffect",
				"",
				L"Which rumble motor for Flame Effect\?",
				L"Both Rumble Motors|Left Rumble Motor|Right Rumble Motor",
				L"Rumble motor to use for Flame Effect"
			);
			this->AutoAddLongComboBoxBlock(
			...
			this->AutoAddShortTrackBarBlock("Flame1pStrength", L"1p Flame Strength", 0, 100, L"Strength of flame effect on device 1");
			this->AutoAddShortTrackBarBlock("Flame2pStrength", L"2p Flame Strength", 0, 100, L"Strength of flame effect on device 2");
