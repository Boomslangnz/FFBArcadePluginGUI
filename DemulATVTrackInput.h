...
namespace FFBPluginGUI {
	...
	public ref class DemulATVTrackInput : Helper
	{
	public:
		DemulATVTrackInput(MetroForm^ obj1)
		{
			this->obj = obj1;
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUp",
				"ExitButton|TestButton|ServiceButton|CreditButton|StartButton|EmergencyStop|VolumeUp|VolumeDown|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Start Button|Emergency Stop|Volume Up|Volume Down|Select no input",
			...
			this->AutoAddLongInputSelect("Button", "EmergencyStopDevice2", L"Emergency Stop");
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUpDevice2",
				"ExitButtonDevice2|TestButtonDevice2|ServiceButtonDevice2|CreditButtonDevice2|StartButtonDevice2|EmergencyStopDevice2|VolumeUpDevice2|VolumeDownDevice2|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Start Button|Emergency Stop|Volume Up|Volume Down|Select no input",
