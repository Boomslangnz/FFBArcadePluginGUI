...
namespace FFBPluginGUI {
	...
	public ref class DemulFasterThanSpeedInput : Helper
	{
	public:
		DemulFasterThanSpeedInput(MetroForm^ obj1)
		{
			this->obj = obj1;
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddLongInputSelect("Button", "BoostButton", L"Boost Button");
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUp",
				"ExitButton|TestButton|ServiceButton|CreditButton|BoostButton|StartButton|ShiftUp|ShiftDown|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Boost Button|Start Button|Shift Up|Shift Down|Select no input",
			...
			this->AutoAddLongInputSelect("Button", "BoostButtonDevice2", L"Boost Button");
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUpDevice2",
				"ExitButtonDevice2|TestButtonDevice2|ServiceButtonDevice2|CreditButtonDevice2|BoostButtonDevice2|StartButtonDevice2|ShiftUpDevice2|ShiftDownDevice2|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Boost Button|Start Button|Shift Up|Shift Down|Select no input",
