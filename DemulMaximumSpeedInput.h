...
namespace FFBPluginGUI {
	...
	public ref class DemulMaximumSpeedInput : Helper
	{
	public:
		DemulMaximumSpeedInput(MetroForm^ obj1)
		{
			this->obj = obj1;
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUp",
				"ExitButton|TestButton|ServiceButton|CreditButton|StartButton|ShiftUp|ShiftDown|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Start Button|Shift Up|Shift Down|Select no input",
			...
			this->AutoAddShortComboBoxBlock(
				"DpadUpDevice2",
				"ExitButtonDevice2|TestButtonDevice2|ServiceButtonDevice2|CreditButtonDevice2|StartButtonDevice2|ShiftUpDevice2|ShiftDownDevice2|",
				L"Dpad Up",
				L"Exit Button|Test Button|Service Button|Credit Button|Start Button|Shift Up|Shift Down|Select no input",
