...
namespace FFBPluginGUI {
	...
	/// Summary for Help
	/// </summary>
	public ref class Help : public MetroFramework::Forms::MetroForm
	{
	public:
		Help(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &Help::metroLink1_Click);
			// 
			// richTextBox1
			// 
			...
			this->richTextBox1->Size = System::Drawing::Size(447, 299);
			...
			// Help
			// 
			this->ClientSize = System::Drawing::Size(493, 358);
			this->Controls->Add(this->richTextBox1);
			this->Controls->Add(this->metroLink1);
			this->MaximizeBox = false;
			this->Name = L"Help";
			this->Resizable = false;
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &Help::Form1_FormClosing);
