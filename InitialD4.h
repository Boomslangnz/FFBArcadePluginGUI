...
namespace FFBPluginGUI {
	...
	/// <summary>
	/// Summary for InitialD4
	/// </summary>
	public ref class InitialD4 : MetroFramework::Forms::MetroForm
	{
	public:
		InitialD4(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &InitialD4::Form1_FormClosing);
			// 
			// metroToolTip1
			// 
		...
		//	this->metroLink1->TabIndex = 30;
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &InitialD4::metroLink1_Click);
			// 
			// metroTrackBar1
			// 
		...
		//	this->metroTrackBar1->TabIndex = 2;
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
		...
		//	this->metroTrackBar2->TabIndex = 3;
			...
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar2_Scroll);
			// 
			// metroTextBox3
			// 
			// 
		...
		//	this->metroTextBox3->TabIndex = 4;
			...
			this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &InitialD4::metroComboBox1_SelectedIndexChanged);
			// 
			// metroTextBox4
			// 
			// 
		...
		//	this->metroCheckBox1->TabIndex = 7;
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
		...
		//	this->metroCheckBox2->TabIndex = 8;
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
		...
		//	this->metroCheckBox3->TabIndex = 9;
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
		...
		//	this->metroCheckBox4->TabIndex = 10;
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
		...
		//	this->metroCheckBox5->TabIndex = 11;
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
		...
		//	this->metroCheckBox6->TabIndex = 12;
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox6_CheckedChanged);
			// 
			// metroCheckBox7
			// 
		...
		//	this->metroCheckBox7->TabIndex = 13;
			...
			this->metroCheckBox7->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox7_CheckedChanged);
			// 
			// metroCheckBox8
			// 
		...
		//	this->metroCheckBox8->TabIndex = 30;
			...
			this->metroCheckBox8->CheckedChanged += gcnew System::EventHandler(this, &InitialD4::metroCheckBox8_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
		...
		//	this->metroTrackBar3->TabIndex = 17;
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar3_Scroll);
			// 
			// metroTrackBar4
			// 
		...
		//	this->metroTrackBar4->TabIndex = 18;
			...
			this->metroTrackBar4->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar4_Scroll);
			// 
			// metroTextBox8
			// 
			// 
		...
		//	this->metroTrackBar5->TabIndex = 21;
			...
			this->metroTrackBar5->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar5_Scroll);
			// 
			// metroTrackBar6
			// 
		...
		//	this->metroTrackBar6->TabIndex = 22;
			...
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD4::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
		...
		//	this->metroLabel1->TabIndex = 23;
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel1_Click);
			// 
			// metroLabel2
			// 
		...
		//	this->metroLabel2->TabIndex = 24;
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel2_Click);
			// 
			// metroLabel3
			// 
		...
		//	this->metroLabel3->TabIndex = 25;
			...
			this->metroLabel3->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel3_Click);
			// 
			// metroLabel4
			// 
		...
		//	this->metroLabel4->TabIndex = 26;
			...
			this->metroLabel4->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel4_Click);
			// 
			// metroLabel5
			// 
		...
		//	this->metroLabel5->TabIndex = 27;
			...
			this->metroLabel5->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel5_Click);
			// 
			// metroLabel6
			// 
		...
		//	this->metroLabel6->TabIndex = 28;
			...
			this->metroLabel6->Click += gcnew System::EventHandler(this, &InitialD4::metroLabel6_Click);
			// 
			// numericUpDown1
			// 
		...
		//	this->numericUpDown1->TabIndex = 29;
			...
			this->numericUpDown1->ValueChanged += gcnew System::EventHandler(this, &InitialD4::numericUpDown1_ValueChanged);
			// 
			// InitialD4
			// 
