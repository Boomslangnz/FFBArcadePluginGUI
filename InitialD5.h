...
namespace FFBPluginGUI {
	...
	/// <summary>
	/// Summary for InitialD5
	/// </summary>
	public ref class InitialD5 : MetroFramework::Forms::MetroForm
	{
	public:
		InitialD5(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &InitialD5::Form1_FormClosing);
			// 
			// metroToolTip1
			// 
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &InitialD5::metroLink1_Click);
			// 
			// metroTrackBar1
			// 
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
			...
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar2_Scroll);
			// 
			// metroTextBox3
			// 
			// 
			...
			this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &InitialD5::metroComboBox1_SelectedIndexChanged);
			// 
			// metroTextBox4
			// 
			// 
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox6_CheckedChanged);
			// 
			// metroCheckBox7
			// 
			...
			this->metroCheckBox7->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox7_CheckedChanged);
			// 
			// metroCheckBox8
			// 
			...
			this->metroCheckBox8->CheckedChanged += gcnew System::EventHandler(this, &InitialD5::metroCheckBox8_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar3_Scroll);
			// 
			// metroTrackBar4
			// 
			...
			this->metroTrackBar4->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar4_Scroll);
			// 
			// metroTextBox8
			// 
			// 
			...
			this->metroTrackBar5->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar5_Scroll);
			// 
			// metroTrackBar6
			// 
			...
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &InitialD5::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel1_Click);
			// 
			// metroLabel2
			// 
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel2_Click);
			// 
			// metroLabel3
			// 
			...
			this->metroLabel3->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel3_Click);
			// 
			// metroLabel4
			// 
			...
			this->metroLabel4->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel4_Click);
			// 
			// metroLabel5
			// 
			...
			this->metroLabel5->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel5_Click);
			// 
			// metroLabel6
			// 
			...
			this->metroLabel6->Click += gcnew System::EventHandler(this, &InitialD5::metroLabel6_Click);
			// 
			// numericUpDown1
			// 
			...
			this->numericUpDown1->ValueChanged += gcnew System::EventHandler(this, &InitialD5::numericUpDown1_ValueChanged);
			// 
			// InitialD5
			// 
