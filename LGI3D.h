...
namespace FFBPluginGUI {
	...
	/// Summary for LGI3D
	/// </summary>
	public ref class LGI3D : MetroFramework::Forms::MetroForm
	{
	public:
		LGI3D(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &LGI3D::Form1_FormClosing);
			// 
			// metroTextBox1
			// 
			// 
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &LGI3D::metroLink1_Click);
			// 
			// metroToolTip1
			// 
			...
			if (SDL_NumJoysticks() == 0)
			{
				...
				this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &LGI3D::metroComboBox1_SelectedIndexChanged);
			// 
			// metroTextBox4
			// 
			// 
			...
			this->numericUpDown3->ValueChanged += gcnew System::EventHandler(this, &LGI3D::numericUpDown3_ValueChanged_1);
			// 
			// metroCheckBox1
			// 
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &LGI3D::metroCheckBox6_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
			...
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar2_Scroll);
			// 
			// metroTrackBar3
			// 
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar3_Scroll);
			// 
			// metroTextBox6
			// 
			// 
			...
			this->metroTrackBar4->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar4_Scroll);
			// 
			// metroTextBox7
			// 
			// 
			...
			this->metroTrackBar5->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar5_Scroll);
			// 
			// metroTrackBar6
			// 
			...
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel1_Click);
			// 
			// metroLabel2
			// 
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel2_Click);
			// 
			// metroTextBox9
			// 
			// 
			...
			if (SDL_NumJoysticks() == 0)
			{
				...
				this->metroComboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &LGI3D::metroComboBox2_SelectedIndexChanged);
			// 
			// metroComboBox3
			// 
			...
			this->metroComboBox3->SelectedIndexChanged += gcnew System::EventHandler(this, &LGI3D::metroComboBox3_SelectedIndexChanged);
			// 
			// metroTextBox10
			// 
			// 
			...
			this->metroComboBox4->SelectedIndexChanged += gcnew System::EventHandler(this, &LGI3D::metroComboBox4_SelectedIndexChanged);
			// 
			// metroTextBox12
			// 
			// 
			...
			this->metroComboBox5->SelectedIndexChanged += gcnew System::EventHandler(this, &LGI3D::metroComboBox5_SelectedIndexChanged);
			// 
			// metroLabel7
			// 
			...
			this->metroLabel7->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel7_Click);
			// 
			// metroLabel8
			// 
			...
			this->metroLabel8->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel8_Click);
			// 
			// metroLabel9
			// 
			...
			this->metroLabel9->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel9_Click);
			// 
			// metroLabel10
			// 
			...
			this->metroLabel10->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel10_Click);
			// 
			// metroTextBox13
			// 
			// 
			...
			this->metroTrackBar7->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar7_Scroll);
			// 
			// metroLabel11
			// 
			...
			this->metroLabel11->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel11_Click);
			// 
			// metroTextBox14
			// 
			// 
			...
			this->metroTrackBar8->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &LGI3D::metroTrackBar8_Scroll);
			// 
			// metroLabel12
			// 
			...
			this->metroLabel12->Click += gcnew System::EventHandler(this, &LGI3D::metroLabel12_Click);
			// 
			// LGI3D
			// 
