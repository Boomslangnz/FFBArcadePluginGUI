...
namespace FFBPluginGUI {
	...
	/// </summary>
	public ref class LindberghHelp : public MetroFramework::Forms::MetroForm
	{
	public:
		LindberghHelp(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(LindberghHelp::typeid));
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &LindberghHelp::metroLink1_Click);
			// 
			// richTextBox1
			// 
			...
			this->Name = L"LindberghHelp";
			this->Resizable = false;
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &LindberghHelp::Form1_FormClosing);
