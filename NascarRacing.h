...
namespace FFBPluginGUI {
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddShortCheckBox("EnableDamperNascarRacing", L"Enable Damper", L"Enable damper to lower wheel oscillation");

			this->AutoAddLongTrackBarBlock("DamperStrengthNascarRacing", L"Damper Strength", 0, 100, L"Strength of damper effect to lower oscillation");

			this->AutoAddLongTrackBarBlock("FeedbackLengthNascarRacing", L"Feedback Length", 16, 10000, L"Length of a feedback command");
