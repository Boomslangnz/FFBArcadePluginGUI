...
namespace FFBPluginGUI {
	...
	/// <summary>
	/// Summary for PokkenTournament
	/// </summary>
	public ref class PokkenTournament : MetroFramework::Forms::MetroForm
	{
	public:
		PokkenTournament(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &PokkenTournament::Form1_FormClosing);
			// 
			// metroTextBox1
			// 
			// 
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &PokkenTournament::metroLink1_Click);
			// 
			// metroToolTip1
			// 
			...
			this->metroToolTip1->SetToolTip(this->metroTextBox10, L"Use both, left or right rumble motor");
			this->metroToolTip1->SetToolTip(this->metroTextBox5, L" Strength of rumble ");
			this->metroToolTip1->SetToolTip(this->metroTextBox8, L" Length of rumble ");
			// 
			// metroStyleManager1
			// 
			...
			if (SDL_NumJoysticks() == 0)
			{
				...
				this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &PokkenTournament::metroComboBox1_SelectedIndexChanged);
			// 
			// metroTextBox4
			// 
			// 
			...
			this->numericUpDown3->ValueChanged += gcnew System::EventHandler(this, &PokkenTournament::numericUpDown3_ValueChanged_1);
			// 
			// metroCheckBox1
			// 
			int EnableRumble = GetPrivateProfileInt(TEXT("Settings"), TEXT("EnableRumble"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroCheckBox1->AutoSize = true;
			this->metroCheckBox1->Location = System::Drawing::Point(20, 293);
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
			int ReverseRumble = GetPrivateProfileInt(TEXT("Settings"), TEXT("ReverseRumble"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroCheckBox2->AutoSize = true;
			this->metroCheckBox2->Location = System::Drawing::Point(163, 293);
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
			int EnableLogging = GetPrivateProfileInt(TEXT("Settings"), TEXT("Logging"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroCheckBox3->AutoSize = true;
			this->metroCheckBox3->Location = System::Drawing::Point(20, 314);
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
			int ResetFB = GetPrivateProfileInt(TEXT("Settings"), TEXT("ResetFeedback"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroCheckBox4->AutoSize = true;
			this->metroCheckBox4->Location = System::Drawing::Point(163, 314);
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
			...
			this->metroCheckBox5->Location = System::Drawing::Point(20, 335);
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
			...
			this->metroCheckBox6->Location = System::Drawing::Point(163, 335);
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &PokkenTournament::metroCheckBox6_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
			...
			this->metroTextBox5->Location = System::Drawing::Point(20, 458);
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &PokkenTournament::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
			...
			this->metroTrackBar2->Location = System::Drawing::Point(20, 484);
			...
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &PokkenTournament::metroTrackBar2_Scroll);
			// 
			// metroTrackBar3
			// 
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &PokkenTournament::metroTrackBar3_Scroll);
			// 
			// metroTextBox8
			// 
			// 
			...
			this->metroTextBox8->Location = System::Drawing::Point(163, 458);
			...
			this->metroTrackBar6->Location = System::Drawing::Point(163, 484);
			...
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &PokkenTournament::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &PokkenTournament::metroLabel1_Click);
			// 
			// metroLabel2
			// 
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &PokkenTournament::metroLabel2_Click);
			// 
			// metroComboBox3
			// 
			int HowtoRumble = GetPrivateProfileInt(TEXT("Settings"), TEXT("HowtoRumble"), 0, TEXT(".\\FFBPlugin.ini"));
			if (HowtoRumble == 0)
			{
			...
			this->metroComboBox3->Location = System::Drawing::Point(20, 423);
			...
			this->metroComboBox3->SelectedIndexChanged += gcnew System::EventHandler(this, &PokkenTournament::metroComboBox3_SelectedIndexChanged);
			// 
			// metroTextBox10
			// 
			// 
			...
			this->metroTextBox10->Lines = gcnew cli::array< System::String^  >(1) { L"Which rumble motor to use\?" };
			this->metroTextBox10->Location = System::Drawing::Point(20, 394);
			...
			this->metroTextBox10->Text = L"Which rumble motor to use\?";
			...
			this->metroLabel7->Location = System::Drawing::Point(67, 510);
			...
			this->metroLabel7->Click += gcnew System::EventHandler(this, &PokkenTournament::metroLabel7_Click);
			// 
			// metroLabel10
			// 
			int RumbleLength1 = GetPrivateProfileInt(TEXT("Settings"), TEXT("RumbleLength"), 0, TEXT(".\\FFBPlugin.ini"));
			this->metroLabel10->AutoSize = true;
			this->metroLabel10->Location = System::Drawing::Point(213, 510);
			...
			this->metroLabel10->Click += gcnew System::EventHandler(this, &PokkenTournament::metroLabel10_Click);
			// 
			// PokkenTournament
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(300, 549);
...
#pragma endregion
	...
	private: System::Void metroComboBox3_SelectedIndexChanged(System::Object^  sender, System::EventArgs^  e) //Which motor for rumble effect?
	{
		...
		{
			WritePrivateProfileStringA("Settings", "HowtoRumble", "0", ".\\FFBPlugin.ini");
		}
		else if (metroComboBox3->SelectedIndex == 1)
		{
			WritePrivateProfileStringA("Settings", "HowtoRumble", "1", ".\\FFBPlugin.ini");
		}
		else if (metroComboBox3->SelectedIndex == 2)
		{
			WritePrivateProfileStringA("Settings", "HowtoRumble", "2", ".\\FFBPlugin.ini");
		}
	}
