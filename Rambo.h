...
namespace FFBPluginGUI {
	...
	public ref class Rambo : Helper
	{
	public:
		Rambo(MetroForm^ obj1)
		{
			this->obj = obj1;
	...
	private:
		void InitializeComponent(void)
		{
			...
			this->AutoAddLongComboBoxBlock(
				"HowtoRumbleRageEffect",
				"",
				L"Which rumble motor for Rage Effect\?",
				L"Both Rumble Motors|Left Rumble Motor|Right Rumble Motor",
				L"Rumble motor to use for Rage Effect"
			);
			this->AutoAddLongComboBoxBlock(
			...
			this->AutoAddShortTrackBarBlock("Rage1pStrength", L"1p Rage Strength", 0, 100, L"Strength of rage effect on device 1");
			this->AutoAddShortTrackBarBlock("Rage2pStrength", L"2p Rage Strength", 0, 100, L"Strength of rage effect on device 2");
