...
namespace FFBPluginGUI {
	...
	/// <summary>
	/// Summary for SonicAllStars
	/// </summary>
	public ref class SonicAllStars : MetroFramework::Forms::MetroForm
	{
	public:
		SonicAllStars(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->SuspendLayout();
			this->FormClosing += gcnew System::Windows::Forms::FormClosingEventHandler(this, &SonicAllStars::Form1_FormClosing);
			// 
			// metroToolTip1
			// 
			...
			this->metroLink1->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLink1_Click);
			...
			this->metroTrackBar1->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar1_Scroll);
			// 
			// metroTrackBar2
			// 
			...
			this->metroTrackBar2->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar2_Scroll);
			// 
			// metroTextBox3
			// 
			// 
			...
			this->metroComboBox1->SelectedIndexChanged += gcnew System::EventHandler(this, &SonicAllStars::metroComboBox1_SelectedIndexChanged);
			// 
			// metroTextBox4
			// 
			// 
			...
			this->metroCheckBox1->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox1_CheckedChanged);
			// 
			// metroCheckBox2
			// 
			...
			this->metroCheckBox2->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox2_CheckedChanged);
			// 
			// metroCheckBox3
			// 
			...
			this->metroCheckBox3->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox3_CheckedChanged);
			// 
			// metroCheckBox4
			// 
			...
			this->metroCheckBox4->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox4_CheckedChanged);
			// 
			// metroCheckBox5
			// 
			...
			this->metroCheckBox5->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox5_CheckedChanged);
			// 
			// metroCheckBox6
			// 
			...
			this->metroCheckBox6->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox6_CheckedChanged);
			// 
			// metroCheckBox7
			// 
			...
			this->metroCheckBox7->CheckedChanged += gcnew System::EventHandler(this, &SonicAllStars::metroCheckBox7_CheckedChanged);
			// 
			// metroTextBox5
			// 
			// 
			...
			this->metroTrackBar3->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar3_Scroll);
			// 
			// metroTrackBar4
			// 
			...
			this->metroTrackBar4->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar4_Scroll);
			// 
			// metroTextBox8
			// 
			// 
			...
			this->metroTrackBar5->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar5_Scroll);
			// 
			// metroTrackBar6
			// 
			...
			this->metroTrackBar6->Scroll += gcnew System::Windows::Forms::ScrollEventHandler(this, &SonicAllStars::metroTrackBar6_Scroll);
			// 
			// metroLabel1
			// 
			...
			this->metroLabel1->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel1_Click);
			// 
			// metroLabel2
			// 
			...
			this->metroLabel2->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel2_Click);
			// 
			// metroLabel3
			// 
			...
			this->metroLabel3->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel3_Click);
			// 
			// metroLabel4
			// 
			...
			this->metroLabel4->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel4_Click);
			// 
			// metroLabel5
			// 
			...
			this->metroLabel5->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel5_Click);
			// 
			// metroLabel6
			// 
			...
			this->metroLabel6->Click += gcnew System::EventHandler(this, &SonicAllStars::metroLabel6_Click);
			// 
			// numericUpDown1
			// 
			...
			this->numericUpDown1->ValueChanged += gcnew System::EventHandler(this, &SonicAllStars::numericUpDown1_ValueChanged);
			// 
			// SonicAllStars
			// 
